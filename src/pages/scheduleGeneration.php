<?php
	...
	if($_POST){
		...
		$sunday = $_POST['Sunday'];
		$sql="UPDATE WorkingSchedule SET Monday = '$monday', Tueday = '$tuesday', Wednesday = '$wednesday',Thursday = '$thursday',Friday = '$friday',Saturday = '$saturday',Sunday = '$sunday' WHERE Username = '$username'";
