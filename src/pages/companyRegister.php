	...
	<body class="forms">
		<form name="companyRegister" style="margin-top: 2%;" method="post" action="companyRegister.php">
  		<div>
			...
			<input type="text" name="irsNum" size="20" maxlength="25" placeholder="IRS Number"/>

			<label for="phoneNo"><b>Phone Number</b></label>
			<input type="text" name="phoneNo" size="20" maxlength="20" placeholder="Phone Number"/>

			<label for="address"><b>Address</b></label>
			<input type="text" name="address" value="" size="20" maxlength="20" placeholder="Adress"/>
			...
			<input type="text" name="zipCode" size="20" maxlength="20" placeholder="Zip Code"/>
...
<!----------------------------------------------------------------------------------------------------------->
		...
		<!-- Action sends to the same page to check the inputs when submit is clicked-->
			<!-- <form name="companyRegister" style="margin-top: 5%;" method="post" action="companyRegister.php">
				<tr>
					<td> 
